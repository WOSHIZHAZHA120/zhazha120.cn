...
import friends_links from '~/shared/friends_links'
</script>

<template>
	<div class="w-full pb-2 overflow-scroll">
		<div class="w-max mx-auto flex justify-center gap-2">
			<template v-for="friends_link in friends_links">
